...
try {
  ...
  const { data } = await axios.get(`https://sadaslk-apis.vercel.app/api/v1/movie/sinhalasub/search?q=${encodeURIComponent(q)}&apiKey=c56182a993f60b4f49cf97ab09886d17`);
...
try {
    ...
    const { data: url } = await axios.get(`https://sadaslk-apis.vercel.app/api/v1/movie/sinhalasub/tv/dl?q=${encodeURIComponent(dllink)}&apiKey=c56182a993f60b4f49cf97ab09886d17`);
...
async (conn, mek, m, {
    ...
    try {
        ...
        // API request
        let sadas = await axios.get(`https://sadaslk-apis.vercel.app/api/v1/movie/sinhalasub/tv/info?q=${encodeURIComponent(q)}&apiKey=c56182a993f60b4f49cf97ab09886d17`);
