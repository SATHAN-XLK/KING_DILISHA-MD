...
cmd({
  ...
  try {
    ...
    const text = `🌍 *Dilisha Country Information: ${info.name}* 🌍\n\n` +
...
try{
    ...
    membersMessage += `\n*╰──────────●●►*\n`
    membersMessage += `*⚡KING_DILISHA-MD*`
